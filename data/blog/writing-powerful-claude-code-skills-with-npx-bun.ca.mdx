...
> **Actualització (Gener 2026):** Després de més proves, he descobert que la detecció de `node_modules` de Bun pot trencar la instal·lació automàtica en situacions inesperades. Ara recomano Deno per a aquest cas d'ús. L'enfocament que es descriu a continuació encara funciona per a scripts independents, però consulta [Per què vaig canviar de Bun a Deno per a Skills de Claude Code](/why-i-switched-from-bun-to-deno-for-claude-code-skills) per a l'explicació completa.
