...
date: '2020-01-29'
spoiler: Un producte mínim viable (MVP) sovint es vincula al món de les startups
  però és una eina molt útil en grans corporacions també. I per tenir èxit amb ell
  és important que els equips d'enginyeria estiguin completament compromesos.
draft: false
tags:
  - mvp
---
...
Tot junt comença a semblar complex de nou, les primeres estimacions de quan es faria eren almenys tres mesos, però probablement més ja que implicaria coordinació amb múltiples equips d'enginyeria, màrqueting, disseny, etc. Escoltant totes les discussions que succeïen la part mandrosa del meu cervell es va activar i vaig fer una pregunta clau al propietari del producte: “_Com es va a dirigir aquest producte als clients per vendre'l a curt termini?_”. La resposta va ser la clau per trobar una manera més fàcil de resoldre aquest problema. Només un petit grup de persones a l'equip de vendes contactarà els clients més importants per vendre el producte, almenys inicialment; i després d'això, avaluaran quins altres clients estarien interessats.
