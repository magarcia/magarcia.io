...
spoiler:
  ...
  paths—making skills fail in monorepos and project directories. Deno's npm:
  specifier provides consistent behavior everywhere, making it the better choice
  for portable Claude Code skills."
...
[my previous npx bun approach](/writing-powerful-claude-code-skills-with-npx-bun)
