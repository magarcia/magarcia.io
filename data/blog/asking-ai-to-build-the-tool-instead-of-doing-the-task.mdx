...
We recently used this approach at [**Buffer**](https://buffer.com) to migrate tooltip components from our legacy design system to a new one. The results were impressive:
