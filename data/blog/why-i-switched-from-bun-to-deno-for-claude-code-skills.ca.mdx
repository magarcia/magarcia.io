...
`~/.cache/deno`. Els directoris `node_modules` locals no afecten la resolució.
Comportament consistent a tot arreu.
...
Si Bun afegeix una bandera per forçar l'autoinstal·lació independentment de la
