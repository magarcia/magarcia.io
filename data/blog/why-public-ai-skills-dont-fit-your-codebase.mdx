...
draft: true
spoiler:
  Generic AI coding skills like Vercel's React Best Practices assume patterns
  your codebase may not use. Learn why companies need custom AI skills that
  encode their specific stack, design system, and conventions—and how to build
  them.
tags:
  - ai
  - developer-tools
...
**Generic AI coding skills produce plausible code that does not fit your
codebase.** Public resources like
[Vercel's React Best Practices](https://vercel.com/blog/introducing-react-best-practices)
and [Impeccable](https://impeccable.style) work well for side projects, but
companies need custom skills that encode their specific stack, design system,
and conventions. This article explains why—and how to start building your own AI
knowledge base.

A "skill" in this context is a structured document—typically markdown with
metadata—that provides context, rules, and examples for AI coding assistants
like [Claude Code](https://code.claude.com/docs/en/skills). Think of it as
machine-readable documentation the AI references before generating code.
