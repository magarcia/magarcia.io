...
> **Actualización (Enero 2026):** Después de más pruebas, he descubierto que la detección de `node_modules` de Bun puede romper la instalación automática en situaciones inesperadas. Ahora recomiendo Deno para este caso de uso. El enfoque que se describe a continuación sigue funcionando para scripts independientes, pero consulta [Por qué cambié de Bun a Deno para Skills de Claude Code](/why-i-switched-from-bun-to-deno-for-claude-code-skills) para la explicación completa.
