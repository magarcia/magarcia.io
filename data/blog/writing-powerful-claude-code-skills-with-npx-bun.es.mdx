...
updated: "2026-01-15"
spoiler:
  "Aprende cómo escribir skills de Claude Code con paquetes npm de terceros y
  sin paso de compilación. Usar npx bun proporciona instalación automática de
  dependencias, soporte nativo de TypeScript y fijado limpio de versiones en
  imports—el equivalente en JavaScript al uv run de Python para scripts
  autocontenidos."
tags:
  - typescript
  - node-js
...
no tienen paso de compilación (_build step_). No puedes simplemente hacer
