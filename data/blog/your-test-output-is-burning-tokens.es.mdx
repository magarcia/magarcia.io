...
Esto es lo que pusimos en producción en Buffer. CI y Claude Code tienen cada uno
su propia configuración de reporter; el desarrollo local mantiene el default.
