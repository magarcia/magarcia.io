...
[Granola](https://www.granola.ai/) is an AI meeting assistant that sits in your menu bar. It records system audio, transcribes locally, and uses LLMs to produce structured summaries—key decisions, action items, discussion points. No bots joining your calls, no awkward "Granola is recording" notifications to your teammates. At [**Buffer**](https://buffer.com), it has become a daily driver for our team.
