...
date: '2020-05-03'
spoiler: Algo que todos los que han estado trabajando con JavaScript por un tiempo han hecho es comprobar si una variable es undefined. En este artículo, explico cuáles son las diferentes formas que puedes usar para ello y las diferencias entre ellas.
tags:
  - javascript
  - principiantes
---
...
Este comportamiento fue arreglado en 2009 con [ECMAScript 5](https://es5.github.io/#x15.1.1.3) :
...
Puedes usar el [operador typeof](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/typeof), que devolverá la cadena `"undefined"` para que puedas comprobarlo.
...
Alternativamente, puedes usar el [operador void](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/void) para comprobar `undefined`. Por ejemplo:
...
> El **operador void** evalúa la _expresión_ dada y luego devuelve [undefined](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/undefined).
