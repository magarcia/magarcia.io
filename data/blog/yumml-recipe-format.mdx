---
title: "YumML: A Human-Readable YAML Recipe Format for the AI Era"
date: "2026-01-10"
spoiler:
  YumML is an open-source recipe format based on YAML that is readable by
  humans, parseable by machines, and optimized for AI assistants. Learn why
  existing recipe formats fail and how YumML solves these problems.
tags:
  - open-source
  - javascript
  - typescript
...
**YumML** is a human-readable recipe format based on YAML that makes cooking
...
machine-parseable and AI-friendly.
...
![XKCD comic 927: A person explains how there are 14 competing standards, so they create a new universal one. Result: 15 competing standards.](https://imgs.xkcd.com/comics/standards.png)
...
_Interested in more open-source projects? Check out
[cross-keychain](/cross-platform-secret-storage-with-cross-keychain), a
cross-platform secret storage library, or see how I used AI to design the
[QWBP protocol](/air-gapped-webrtc-breaking-the-qr-limit) for serverless
WebRTC._
