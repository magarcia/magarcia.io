...
En mi [post anterior](/2016/07/03/events-in-angular2/), estuve hablando sobre cómo
...
Empiezo definiendo el problema. Podemos tener una directiva o componente de Angular 1
como este:
...
> La sintaxis **set** vincula una propiedad de objeto a una función para ser llamada cuando
> hay un intento de establecer esa propiedad.
