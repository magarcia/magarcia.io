...
En el meu [post anterior](/2016/07/03/events-in-angular2/), vaig estar parlant
...
> La sintaxi **set** vincula una propietat d'objecte a una funció per ser
> cridada quan hi ha un intent d'establir aquesta propietat.
