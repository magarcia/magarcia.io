...
Això és el que vam posar en producció a Buffer. CI i Claude Code tenen cadascun
la seva pròpia configuració de reporter; el desenvolupament local manté el
default.
