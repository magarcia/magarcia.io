...
date: "2026-01-10"
spoiler:
  Els formats de receptes existents són antics, estan mal especificats o tenen
  restriccions de llicència. YumML fa les receptes de cuina llegibles tant per a
  humans com per a màquines.
tags:
  - open-source
---

Fa anys, parlant amb un amic, ens vam adonar que no existeix cap format
estàndard per desar receptes de cuina. En aquell moment estava aprenent React, i
