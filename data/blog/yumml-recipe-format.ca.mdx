...
Fa anys, parlant amb un amic, ens vam adonar que no existeix un format estàndard
...
(com molts projectes que vaig començar i mai vaig acabar), però en el camí vaig
trobar un esborrany d'especificació d'un format de receptes: **YumML**.

<br />

![XKCD: Estàndards](https://imgs.xkcd.com/comics/standards.png)

*Sí, soc plenament conscient de la ironia. [xkcd.com/927](https://xkcd.com/927)*

<br />

Paul Jenkins va publicar aquest format a [vikingco.de](http://vikingco.de/), però
el lloc ara està fora de línia. Les úniques referències disponibles són de l'
...
Aquest esborrany és prometedor com a format per a receptes de cuina, així que vull
recuperar-lo dels arxius oblidats i reviure'l, afegint funcionalitats i
especificacions extra.

## Motivació

Com l'autor original de YumML va mencionar en el seu post, he investigat formats de
receptes de cuina i, sent clar, la majoria fan pena. El panorama de formats
d'intercanvi de receptes està fragmentat, però la majoria comparteixen un tret:
manquen de llegibilitat humana.

La majoria del programari de cuina utilitza formats propietaris que només aquest
programari pot llegir. Alguns poden ser importats per altres programes.
...
Però mirant un exemple, el format sembla mal especificat:
