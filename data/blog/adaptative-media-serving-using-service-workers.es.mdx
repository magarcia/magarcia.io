...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td data-column="Explicación">La red es adecuada para transferencias de activos grandes como imágenes de alta resolución, audio y vídeo SD.</td>
      </tr>
      <tr>
         <td  data-column="ECT">4g</td>
         <td data-column="RTT">0</td>
         <td data-column="Downlink">∞</td>
         <td data-column="Explicación">La red es adecuada para vídeo HD, vídeo en tiempo real, etc.</td>
      </tr>
   </tbody>
...
vídeo HD, imagen HD o imagen de baja calidad, el enfoque sugerido por
