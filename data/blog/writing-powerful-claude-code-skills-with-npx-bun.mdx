...
updated: "2026-01-15"
spoiler:
  Learn how to write Claude Code skills with third-party npm packages and no
  build step. Using npx bun provides auto-installing dependencies, native
  TypeScript support, and clean version pinning in imports—the JavaScript
  equivalent of Python's uv run for self-contained scripts.
...
The problem:
[Claude Code skills](https://docs.anthropic.com/en/docs/claude-code/skills) have
