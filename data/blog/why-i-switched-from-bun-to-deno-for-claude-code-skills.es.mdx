...
date: "2026-01-15"
spoiler: "La autoinstalación de Bun se rompe cuando existe cualquier directorio node_modules en las rutas padres—un problema para skills portables. El especificador npm: de Deno funciona en todas partes, desde directorios de proyecto hasta monorepos, sin sorpresas."
tags:
  - typescript
  - deno
  - bun
...
La semana pasada escribí sobre [usar npx bun para escribir skills de Claude Code](/es/writing-powerful-claude-code-skills-with-npx-bun) con dependencias de terceros. El enfoque funcionaba para casos simples—scripts autocontenidos con paquetes que se autoinstalan, sin paso de compilación. Pero después de usarlo en entornos reales, descubrí un problema significativo.
...
El crédito por la solución es para [J Edward Wynia](https://www.threads.net/@jwynia/post/DTgiB62DaxN), quien me señaló hacia Deno en respuesta a ese artículo. Olvidé por qué me salté Deno inicialmente—probablemente porque la sintaxis de Bun parecía más limpia—pero la sugerencia era correcta.
...
La estructura sigue el mismo patrón del [artículo original](/es/writing-powerful-claude-code-skills-with-npx-bun)—un `SKILL.md` apuntando a scripts ejecutables. Los únicos cambios son el shebang y las APIs específicas de Deno:
...
- [Escribiendo Potentes Skills de Claude Code con npx bun](/es/writing-powerful-claude-code-skills-with-npx-bun) — La exploración original de este enfoque
- [Deno — Un runtime moderno para JavaScript y TypeScript](https://deno.land)
- [Compatibilidad npm de Deno](https://docs.deno.com/runtime/fundamentals/node/#using-npm-packages) — Cómo funciona el especificador `npm:`
- [Documentación de Autoinstalación de Bun](https://bun.sh/docs/runtime/auto-install) — Entendiendo cuándo se activa la autoinstalación
