---
title: YumML - Otra Metadatos de Recetas
date: '2020-01-06'
...
Hace algún tiempo, hablando con un amigo nos dimos cuenta de que no hay un formato "estándar"
para guardar recetas de cocina. En ese momento estaba aprendiendo React y uno de los
primeros proyectos que intenté hacer fue una app de gestión de recetas. No tuve éxito en
ese proyecto (como muchos otros que empecé y nunca terminé) pero en el camino
encontré un borrador de especificación de un formato de recetas: **YumML**.

Este formato fue publicado en ese momento en [vikingco.de](http://vikingco.de/) pero
el sitio ya no está disponible. Las únicas referencias disponibles son del
...
Desde mi punto de vista, este borrador es realmente prometedor como un formato para recetas de
cocina, así que quiero recuperarlo de los archivos olvidados de Internet y traerlo
a la vida de nuevo, añadiendo algunas funcionalidades/especificaciones extra.

## Motivación

Como el autor original de YumML mencionó en su post de blog original, he estado
investigando un poco sobre formatos de recetas para cocina y siendo claro, la mayoría de
ellos apestan. El panorama de formatos de intercambio de recetas está bastante fragmentado, pero
la mayoría de ellos tienen una cosa en común: no son realmente amigables para los humanos.

Mucho software relacionado con la cocina viene con un formato que usualmente solo ese
software es capaz de trabajar con y entender. Aunque algunos de ellos pueden ser
importados por otros programas.
...
Pero mirando un ejemplo, no parece algo bien especificado:
...
Desde mi lado quiero definir unos objetivos más formales para la especificación.
